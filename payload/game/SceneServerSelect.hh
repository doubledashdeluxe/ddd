...
private:
    ...
    bool m_canContinue[MaxServerCount];
    bool m_canUpdate[MaxServerCount];
    ClientStateServerWriteInfo m_writeInfo;
    u32 m_nextScene;
    J2DScreen m_mainScreen;
    J2DScreen m_installScreen;
    ...
    J2DAnmBase *m_installAnmTransform;
