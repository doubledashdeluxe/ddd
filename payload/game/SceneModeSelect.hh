...
private:
    ...
    u32 m_modeIndex;
    Array<Array<char, 80>, ModeIndexCount> m_descs;
    Array<u64, ModeIndexCount> m_descOffsets;
    Array<Array<char, 4>, ModeIndexCount> m_playerCounts;
    u32 m_nextScene;
    J2DScreen m_mainScreen;
    Array<J2DScreen, ModeIndexCount> m_modeScreens;
    J2DAnmBase *m_mainAnmTransform;
    Array<J2DAnmBase *, ModeIndexCount> m_modeAnmTransforms;
    Array<J2DAnmBase *, ModeIndexCount> m_descAnmTransforms;
    u8 m_mainAnmTransformFrame;
    Array<u8, ModeIndexCount> m_modeAnmTransformFrames;
    Array<u8, ModeIndexCount> m_descAnmTransformFrames;
    Array<u8, ModeIndexCount> m_descAlphas;
};
