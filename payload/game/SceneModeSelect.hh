...
private:
    ...
    u32 m_modeIndex;
    Array<Array<char, 80>, ModeIndex::Count> m_descs;
    Array<u64, ModeIndex::Count> m_descOffsets;
    Array<Array<char, 4>, ModeIndex::Count> m_playerCounts;
    u32 m_nextScene;
    J2DScreen m_mainScreen;
    Array<J2DScreen, ModeIndex::Count> m_modeScreens;
    J2DAnmBase *m_mainAnmTransform;
    Array<J2DAnmBase *, ModeIndex::Count> m_modeAnmTransforms;
    Array<J2DAnmBase *, ModeIndex::Count> m_descAnmTransforms;
    u8 m_mainAnmTransformFrame;
    Array<u8, ModeIndex::Count> m_modeAnmTransformFrames;
    Array<u8, ModeIndex::Count> m_descAnmTransformFrames;
    Array<u8, ModeIndex::Count> m_descAlphas;
};
