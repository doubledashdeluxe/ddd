...
Apploader::GameEntryFunc Apploader::Run(ReadFunc read) {
    ...
    if (!Read(read, reinterpret_cast<void *>(0x81200000), AlignUp(header.size, 0x20), 0x2460,
                hashes)) {
        ERROR("Failed to read apploader.");
        return nullptr;
    }
    ICache::Invalidate(reinterpret_cast<void *>(0x81200000), header.size);
...
const Array<u8, 32> Apploader::HashesP[18] = {
        ...
        Array<u8, 32>((u8[32]){0x06, 0x77, 0x63, 0xce, 0x9f, 0x25, 0x0b, 0x65, 0xe0, 0x77, 0x5e,
                0xba, 0x7d, 0xb0, 0x61, 0x46, 0xc2, 0xf4, 0x38, 0x0d, 0x26, 0x79, 0xd7, 0x2e, 0x82,
                0x88, 0xb2, 0xb4, 0x71, 0xf8, 0xb5, 0xc7}),
