...
CHUNKS = {
    'P': {
        'E': [
            ...
            Chunk(0x80333a20, 0x80333a2c, 0x80329be0),
            Chunk(0x80337f98, 0x80338038, 0x8032e1c8),
            Chunk(0x80338234, 0x803382c8, 0x8032e464),
            Chunk(0x80346c20, 0x80346c38, 0x8033cde0),
            Chunk(0x80347af8, 0x80347b08, 0x8033dcb8),
            Chunk(0x80347e70, 0x80347ec0, 0x8033e030),
            Chunk(0x80348318, 0x80348338, 0x8033e4d8),
            Chunk(0x8035192c, 0x80351968, 0x80347aec),
            Chunk(0x80355478, 0x803554c8, 0x8034b638),
            Chunk(0x8035c1f0, 0x8035c208, 0x803523b0),
            Chunk(0x8035c638, 0x8035c688, 0x803527f8),
            Chunk(0x8035cbc8, 0x8035cc20, 0x80352d88),
            Chunk(0x8035cc88, 0x8035cca0, 0x80352e48),
            Chunk(0x80371e08, 0x80371e68, 0x80367fc8),
            Chunk(0x80379a60, 0x80379a8c, 0x8036fc20),
            Chunk(0x80379ae0, 0x80379b88, 0x8036fca0),
            Chunk(0x803802a0, 0x803802b8, 0x80376460),
            Chunk(0x80389d80, 0x80389db0, 0x8037ff40),
            Chunk(0x80389e00, 0x80389e20, 0x8037ffc0),
            Chunk(0x803ae998, 0x803ae99c, 0x803a4b78),
            Chunk(0x803b6db0, 0x803b6ec8, 0x803acf90),
            Chunk(0x803bad54, 0x803bb1e0, 0x803b0f34),
            ...
            Chunk(0x803d3288, 0x803d328c, 0x803c9460),
            Chunk(0x803d332c, 0x803d3330, 0x803c9504),
            Chunk(0x803d3b08, 0x803d3b10, 0x803c9ce0),
            Chunk(0x803d4980, 0x803d4988, 0x803cab40),
            Chunk(0x803d4998, 0x803d499c, 0x803cab60),
            Chunk(0x803d4aa0, 0x803d4aac, 0x803cac68),
            Chunk(0x803d4b78, 0x803d4b94, 0x803cad40),
            Chunk(0x803d4c40, 0x803d4c44, 0x803cae08),
            Chunk(0x803d4d50, 0x803d4d64, 0x803caf18),
            Chunk(0x803d4e0c, 0x803d4e18, 0x803cafd4),
            Chunk(0x803d5068, 0x803d506c, 0x803cb230),
            Chunk(0x803d5184, 0x803d5188, 0x803cb34c),
            Chunk(0x803d51c4, 0x803d51d8, 0x803cb38c),
            Chunk(0x803d540c, 0x803d5410, 0x803cb5cc),
            Chunk(0x803d5498, 0x803d549c, 0x803cb658),
            Chunk(0x803d5500, 0x803d5544, 0x803cb6c0),
            Chunk(0x803d5568, 0x803d5584, 0x803cb728),
            Chunk(0x803d55e0, 0x803d5604, 0x803cb7a0),
            Chunk(0x803d5628, 0x803d5634, 0x803cb7e8),
            Chunk(0x803d5ab0, 0x803d5ab4, 0x803cbc70),
            Chunk(0x803d5b30, 0x803d5b38, 0x803cbcf0),
            Chunk(0x803d5b60, 0x803d5c64, 0x803cbd20),
            Chunk(0x803d5c98, 0x803d5cbc, 0x803cbe58),
            Chunk(0x803d5cd0, 0x803d5cdc, 0x803cbe90),
            Chunk(0x803d5d40, 0x803d5d44, 0x803cbf00),
            Chunk(0x803d5d80, 0x803d5d84, 0x803cbf40),
            Chunk(0x803d63c8, 0x803d63cc, 0x803cc588),
        ],
        'J': [
            Chunk(0x80003100, 0x800b07e8, 0x80003100),
            Chunk(0x800b07e8, 0x800eac24, 0x800b0824),
            ...
            Chunk(0x80333a20, 0x80333a2c, 0x80344200),
            Chunk(0x80337f98, 0x80338038, 0x803487e8),
            Chunk(0x80338234, 0x803382c8, 0x80348a84),
            Chunk(0x80346c20, 0x80346c38, 0x80357400),
            Chunk(0x80347af8, 0x80347b08, 0x803582d8),
            Chunk(0x80347e70, 0x80347ec0, 0x80358650),
            Chunk(0x80348318, 0x80348338, 0x80358af8),
            Chunk(0x8035192c, 0x80351968, 0x8036210c),
            Chunk(0x80355478, 0x803554c8, 0x80365c58),
            Chunk(0x8035c1f0, 0x8035c208, 0x8036c9d0),
            Chunk(0x8035c638, 0x8035c688, 0x8036ce18),
            Chunk(0x8035cbc8, 0x8035cc20, 0x8036d3a8),
            Chunk(0x8035cc88, 0x8035cca0, 0x8036d468),
            Chunk(0x80371e08, 0x80371e68, 0x803825e8),
            Chunk(0x80379a60, 0x80379a8c, 0x8038a240),
            Chunk(0x80379ae0, 0x80379b88, 0x8038a2c0),
            Chunk(0x803802a0, 0x803802b8, 0x80390a80),
            Chunk(0x80389d80, 0x80389db0, 0x8039a560),
            Chunk(0x80389e00, 0x80389e20, 0x8039a5e0),
            Chunk(0x803ae998, 0x803ae99c, 0x803bf198),
            Chunk(0x803b6db0, 0x803b6ec8, 0x803c75b0),
            Chunk(0x803bad54, 0x803bb1e0, 0x803cb554),
            ...
            Chunk(0x803d3288, 0x803d328c, 0x803e3a78),
            Chunk(0x803d332c, 0x803d3330, 0x803e3b1c),
            Chunk(0x803d3b08, 0x803d3b10, 0x803e42f8),
            Chunk(0x803d4980, 0x803d4984, 0x803e3a44),
            Chunk(0x803d4998, 0x803d499c, 0x803e5188),
            Chunk(0x803d4aa0, 0x803d4aac, 0x803e5290),
            Chunk(0x803d4b78, 0x803d4b94, 0x803e5368),
            Chunk(0x803d4c40, 0x803d4c44, 0x803e5430),
            Chunk(0x803d4d50, 0x803d4d64, 0x803e5540),
            Chunk(0x803d4e0c, 0x803d4e18, 0x803e55fc),
            Chunk(0x803d5068, 0x803d506c, 0x803e5858),
            Chunk(0x803d5184, 0x803d5188, 0x803e5974),
            Chunk(0x803d51c4, 0x803d51d8, 0x803e59c4),
            Chunk(0x803d540c, 0x803d5410, 0x803d5bec),
            Chunk(0x803d5498, 0x803d549c, 0x803e5c78),
            Chunk(0x803d5500, 0x803d5544, 0x803e5ce0),
            Chunk(0x803d5568, 0x803d5584, 0x803e5d48),
            Chunk(0x803d55e0, 0x803d5604, 0x803e5dc0),
            Chunk(0x803d5628, 0x803d5634, 0x803e5e08),
            Chunk(0x803d5ab0, 0x803d5ab4, 0x803e6290),
            Chunk(0x803d5b30, 0x803d5b38, 0x803e6310),
            Chunk(0x803d5b60, 0x803d5c64, 0x803e6340),
            Chunk(0x803d5c98, 0x803d5cbc, 0x803e6478),
            Chunk(0x803d5cd0, 0x803d5cdc, 0x803e64b0),
            Chunk(0x803d5d40, 0x803d5d44, 0x803e6520),
            Chunk(0x803d5d80, 0x803d5d84, 0x803e6560),
            Chunk(0x803d63c8, 0x803d63cc, 0x803e6ba8),
        ],
    },
    'E': {
        'J': [
